...
app.include_router(points_shop.router, tags=["Points Shop"])
app.include_router(search.router, tags=["Search"])
app.include_router(activity_feed.router, tags=["Activity Feed"])
app.include_router(wipes.router, tags=["Wipes"])
...
app.include_router(clans.router, tags=["Clans"])
app.include_router(leaderboard.router, tags=["Leaderboard"])
app.include_router(plugin_integration.router, tags=["Plugin Integration"])
app.include_router(server_admin.router, tags=["Admin — Servers"])
...
app.include_router(admin_misc.router, tags=["Admin — Misc"])
app.include_router(moderation.router, tags=["Admin — Moderation"])
